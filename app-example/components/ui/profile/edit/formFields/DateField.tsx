                    ...
                    <View style={styles.modalOverlay}>
                        <View style={styles.modalContainer}>
                            ...
                            <View style={styles.modalHeaderRow}>
                                <Text style={styles.modalDate}>{getDayMonthYear(tempDate)}</Text>
                                <TouchableOpacity onPress={() => {
                                    setModalVisible(false);
                                    setEditModalVisible(true);
                                }}>
                                    <Image source={pencil} style={{ height: 36 }} resizeMode="contain" />
                                </TouchableOpacity>
                            ...
                            <View style={styles.monthRow}>
                                <View style={styles.monthDropdownWrapper}>
                                    ...
                                    >
                                        ...
                                        <View>
                                            <Image source={dropdown} style={{ height: 5 }} resizeMode="contain" />
                                        </View>
                                    </TouchableOpacity>
                                </View>
                                ...
                                <View style={styles.arrowRow}>
                                    ...
                                    >
                                        <CaretLeft size={18} weight="bold" color={Colors.blackMain} />
                                    </Text>
                                    <Text
                                        style={styles.arrow}
                                        onPress={() =>
                                    ...
                                    >
                                        {Array.from({ length: 101 }, (_, i) => 2025 - i).map((yr) => (
                                            <TouchableOpacity
                                                key={yr}
                                                onPress={() => {
                                                    setTempDate(new Date(yr, tempDate.getMonth(), tempDate.getDate()));
                                                    setShowYearDropdown(false);
                                                }}
                                            >
                                                <Text
                                                    style={[
                                                        styles.yearOption,
                                                        yr === tempDate.getFullYear() && styles.selectedYear,
                                                    ]}
                                                >
                                                    {yr}
                                                </Text>
